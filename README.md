    ...
    # Yet Another Dotfile Repo v1.1g
...
A fork of YADR, without the vimify of your precious command line. 
...
```bash
sh -c "`curl -fsSL https://raw.github.com/chalofa/dotfiles/master/install.sh`" -s ask
```
